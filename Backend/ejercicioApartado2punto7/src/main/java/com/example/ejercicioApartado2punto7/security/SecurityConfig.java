package com.example.ejercicioApartado2punto7.security;

import com.example.ejercicioApartado2punto7.security.jwt.JwtAuthenticationFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .authorizeHttpRequests((authz) -> authz
                        .requestMatchers(antMatcher("/socio/**")).hasRole("SOCIO")
